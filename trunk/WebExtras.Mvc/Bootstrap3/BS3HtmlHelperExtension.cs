...
namespace WebExtras.Mvc.Bootstrap3
{
  ...
  /// </summary>
  public static class BS3HtmlHelperExtension
  {
    ...
    public static IExtendedHtmlString Glyph(this HtmlHelper html, EBootstrap3Glyph icon, object htmlAttributes = null)
    {
      Italic i = new Italic();
    ...
    /// <param name="htmlAttributes">Extra HTML attributes</param>
    /// <returns>A Bootstrap icon</returns>
    public static IExtendedHtmlString Glyph(this HtmlHelper html, EFontAwesomeIcon icon, object htmlAttributes)
    {
      return Glyph(html, icon, EFontAwesomeIconSize.Normal, htmlAttributes);
    }
    ...
    /// <param name="htmlAttributes">Extra HTML attributes</param>
    /// <returns>A Bootstrap icon</returns>
    public static IExtendedHtmlString Glyph(this HtmlHelper html, EFontAwesomeIcon icon, EFontAwesomeIconSize size = EFontAwesomeIconSize.Normal, object htmlAttributes = null)
    {

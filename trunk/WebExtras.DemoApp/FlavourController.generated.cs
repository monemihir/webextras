...
namespace WebExtras.DemoApp.Controllers
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_FlavourController : WebExtras.DemoApp.Controllers.FlavourController
    {
        ...
        [NonAction]
        partial void BuildDetailsOverride(T4MVC_System_Web_Mvc_ContentResult callInfo);

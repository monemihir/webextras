...
namespace WebExtras.DemoApp.Areas.Gumby.Controllers
{
    public partial class CoreController
    {
        ...
        public class ViewsClass
        {
            ...
            public readonly string JQPlot = "~/Areas/Gumby/Views/Core/JQPlot.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_CoreController : WebExtras.DemoApp.Areas.Gumby.Controllers.CoreController
    {

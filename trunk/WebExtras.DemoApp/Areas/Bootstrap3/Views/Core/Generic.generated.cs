...
namespace ASP
{
    ...
    [System.Web.WebPages.PageVirtualPathAttribute("~/Areas/Bootstrap3/Views/Core/Generic.cshtml")]
    public partial class _Areas_Bootstrap3_Views_Core_Generic_cshtml : System.Web.Mvc.WebViewPage<dynamic>
    {
        public _Areas_Bootstrap3_Views_Core_Generic_cshtml()
        {
        }
        public override void Execute()
        {
            ...
            #line 1 "..\..\Areas\Bootstrap3\Views\Core\Generic.cshtml"
...
"ent system culture\r\n    </div>    \r\n  </div>\r\n  <div class=\"row\">\r\n    <div clas" +
"s=\"col-md-6\">\r\n      <pre><code>\r\n  <span class=\"comment\">// Enum definition</sp" +
...
"umvalue\r\n    </code></pre>\r\n    </div>    \r\n  </div>\r\n  <div class=\"row\">\r\n    <" +
"div class=\"col-md-12\">\r\n      GetStringValue() simply retrieves the string value" +
" decorated either using a static\r\n      text or by using a <span class=\"highligh" +
"t\">IStringValueDecider</span> implementation of the StringValue attribute. \r\n   " +
"   This is especially useful if you want an enum value to have an integer repres" +
"entation \r\n      as well as a string representation.\r\n    </div>\r\n  </div>\r\n  <d" +
"iv class=\"row\">\r\n    <div class=\"col-md-6\">\r\n      <pre><code>\r\n  <span class=\"c" +
"omment\">// Invocation of GetStringValue</span>\r\n  TestEnum.enumvalue.GetStringVa" +
"lue()\r\n\r\n  <span class=\"comment\">// Output</span>\r\n  My great Enum\r\n    </code><" +
"/pre>\r\n    </div>\r\n    <div class=\"col-md-6\">\r\n      <pre><code>\r\n  <span class=" +
"\"comment\">// This is how MyCustomStringValueDecider class looks</span>\r\n  class " +
"MyCustomStringValueDecider : IStringValueDecider\r\n  {\r\n    public string Decide(" +
")\r\n    {\r\n      <span class=\"comment\">// Let us say we evaluated some condition " +
"here<br />      // and our result was \"my decided value\"</span>\r\n      return \"m" +
"y decided value\";\r\n    }\r\n  }\r\n\r\n  <span class=\"comment\">// Invocation of GetStr" +
"ingValue on a value that has a <br />  // custom string value decider</span>\r\n  " +
...
" class=\"row\">\r\n    <div class=\"col-md-4\">\r\n      ToTitleCase() as the method nam" +
"e suggests will convert the string \r\n      value to it\'s titlecase representatio" +
"n based on the current system culture\r\n    </div>\r\n    <div class=\"col-md-4\">\r\n " +
...
"tive of case\r\n    </div>\r\n    <div class=\"col-md-4\">\r\n        Remove() method re" +
"moves all occurences of the given string from it\'s parent string. This extension" +
" \r\n        simply uses the Replace() method internally but making use of Remove(" +
